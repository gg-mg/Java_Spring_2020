...
public class MyWorld extends World
{
    ...
    //**for background song need to shrink only for "we are going this way for up and down, this way ect)
    //private GreenfootSound catchFishSong = new GreenfootSound("slurp.wav");//need edit new song
   ...
   /**
    ...
    public void act()
    {
        ...
        {
            addObject(new Fish(),1, Greenfoot.getRandomNumber(360));
