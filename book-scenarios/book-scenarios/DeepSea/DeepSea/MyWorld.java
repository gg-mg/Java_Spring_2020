...
public class MyWorld extends World
{
    ...
    private GreenfootSound catchFishSong = new GreenfootSound("longbeat3.mp3");//need edit new song    
    private GreenfootSound catchCrabSong = new GreenfootSound("wowStretch4.mp3");
    //private GreenfootSound missSong = new GreenfootSound(" au.wav");
    private GreenfootSound finalSong = new GreenfootSound("gameEnd7.mp3");
    private int score;
    private int time;
   ...
   /**
    ...
    public void setCatchFishSong(GreenfootSound catchFishSong)
    {
      ...
      public GreenfootSound getCatchCrabSong()
    {
         return catchCrabSong;
    }
    public void setCatchCrabSong(GreenfootSound catchCrabSong)
    {
        this.catchCrabSong = catchCrabSong;
    }
