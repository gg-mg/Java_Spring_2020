/**
 * This example corresponds to Figure 4 in file
 * "MemoryManagementForObject.docx". Figure 4 is to explain the difference
 * between passing a primitive data type (such as int) and passing a class data
 * type (such as class Student), as parameter for a method.
 */
