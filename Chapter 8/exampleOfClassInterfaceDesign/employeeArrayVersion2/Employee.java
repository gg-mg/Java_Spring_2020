 ...
 *   However, it has dummy implementation of the methods in interface, which enables  
 *     dynamic binding in an array of object of different subclasses. 
...
public class Employee
{
	...
	public double calcSalary(){   // dummy implementation for dynamic binding
		return 0.0; 
	}
	
	public double calcTakeHome() { // dummy implementation for dynamic binding
		return 0.0;
	} 	
